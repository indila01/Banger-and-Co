...
export const BOOKING_SAVE_BOOKING_DETAILS = 'BOOKING_SAVE_BOOKING_DETAILS'
export const BOOKING_SAVE_VEHICLE_DETAILS = 'BOOKING_SAVE_VEHICLE_DETAILS'
export const BOOKING_SAVE_EQUIPMENTS_DETAILS = 'BOOKING_SAVE_EQUIPMENTS_DETAILS'
...
export const BOOKING_VERIFY_REQUEST = 'BOOKING_VERIFY_REQUEST'
export const BOOKING_VERIFY_SUCCESS = 'BOOKING_VERIFY_SUCCESS'
export const BOOKING_VERIFY_FAIL = 'BOOKING_VERIFY_FAIL'
export const BOOKING_VERIFY_RESET = 'BOOKING_VERIFY_RESET'
