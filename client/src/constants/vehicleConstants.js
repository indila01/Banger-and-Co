...
export const VEHICLE_COMPARE_REQUEST = 'VEHICLE_COMPARE_REQUEST'
export const VEHICLE_COMPARE_SUCCESS = 'VEHICLE_COMPARE_SUCCESS'
export const VEHICLE_COMPARE_FAIL = 'VEHICLE_COMPARE_FAIL'
